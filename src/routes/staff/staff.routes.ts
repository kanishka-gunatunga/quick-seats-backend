...
import { issueTickets,ticketVerify,confirmTicketIssue,issueNoSeatTickets,issueTicketsManual,getOrderTickets } from '../../controllers/staff/ticketController';
...
router.get('/issue-tickets-manual', isStaffLoggedIn, issueTicketsManual);
router.post('/get-order-tickets', getOrderTickets);
